...
<body>
    ...
    <div class="content">
        <h1>List of Designations</h1>
        <div class="mb-4">
            <a href="dashboard.php" class="btn btn-secondary">Back to Dashboard</a>
            <a href="designations.php" class="btn btn-primary">Add Designation</a>
        </div>
        <?php if ($error) { ?>
            ...
            <tbody>
                <?php if (!empty($designations)) { ?>
                    <?php foreach ($designations as $designation) { ?>
                        <tr>
                            <td><?php echo htmlspecialchars($designation['id']); ?></td>
